...
class PrevGeracaoEolicaONSDAO:
    def __init__(self) -> None:
        self.prev_geracao_eolica_ons = MongoTempoOK()["prev_geracao_eolica_ons"]

    def buscar_prev_geracao_eolica_horario_ons_mais_recente(self) -> pd.DataFrame:
        """
        ...
        return pd.DataFrame(
            list(
                self.prev_geracao_eolica_ons.aggregate(
                    [
                        {
                            "$project": {
                                "_id": False,
